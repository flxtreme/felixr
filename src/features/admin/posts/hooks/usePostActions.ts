...
import { createPost, deletePost, updatePost } from "@/src/features/admin/posts/services";
...
const usePostActions = () => {
  ...
  const update = async (id: string, payload: UpdatePostPayload) => {
  ...
  const remove = async (id: string, payload: DeletePostPayload) => {
